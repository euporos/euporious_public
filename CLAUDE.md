...
- App code changes require building a new uberjar in the app checkout on the box and restarting the service (`sudo systemctl restart euporious_public` — passwordless for user `phylax`).
